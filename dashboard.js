(function() {
    ...
    var OTHER_LINKS = {
        apiDocs: 'https://shenjack.top:10003/docs',
        qqGroup: 'https://qm.qq.com/q/ux1dXhwhZ8',
    };

    function applyLinks() {
        document.querySelectorAll('[data-link]').forEach(function(el) {
            var key = el.getAttribute('data-link');
            var url = PLATFORM_LINKS[key] || FRIENDLY_LINKS[key] || OTHER_LINKS[key];
   ...
   var mockData = {
    totalViews: 1777777,
    totalRequests: 112193629, harmonyTotalRequests: 1282864, todayRequests: 802067,
};
